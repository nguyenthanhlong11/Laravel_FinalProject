    ...
    <div class="container">
        <div class="menu">
            <div class="topnav" id="myTopnav">
                <a href="../index.php"><span class="index.php"></span>TRANG CHỦ</a>
            ...
            <div style="display:flex">
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-9">
                    <div class="gt">
                        <h3>Cơ sở 1</h3>
                        Địa chỉ: Số 101B Lê Hữu Trác, Sơn Trà, Đà Nẵng<br>
                        Hotline:0357764225<br>
                        Email: long@gmail.com <br>
                        <img src="../Image/lienhe2.jpg" width="400" height="300">
                    </div>
                </div>
                <!-- ------------------------------------------------------------------------------------------------------- -->
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-9">
                    <div class="gt">
                        <h3>Cơ sở 2</h3>
                        Địa chỉ: Bắc Trà My, Quảng Nam<br>
                        Hotline:0357764225<br>
                        Email: long@gmail.com<br>
                        <img src="../Image/lienhe1.jpg" width="400" height="300">
                    </div>
                </div>
            </div>
